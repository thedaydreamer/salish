...
public enum ModifierEnum {
	...
	PRIVATE(Modifier.PRIVATE), PROTECTED(Modifier.PROTECTED),
	PUBLIC(Modifier.PUBLIC), STATIC(Modifier.STATIC),
	STRICT(Modifier.STRICT), SYNCHRONIZED(Modifier.SYNCHRONIZED),
	...
	/**
	 * Returns the integer for this modifier.  Maps the integer found in
	 * Modifier to this enum value.
