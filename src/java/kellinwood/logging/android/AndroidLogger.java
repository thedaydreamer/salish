...
public class AndroidLogger extends AbstractLogger {
	...
	// Constructs the logger so that only the last component of the class name
	// is used for the logging tag.
	// E.g., A parameter value of kellinwood.zipsigner.ZipPickerActivity results
	// in a tag value of "ZipPickerActivity".
