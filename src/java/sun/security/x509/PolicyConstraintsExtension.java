...
public class PolicyConstraintsExtension extends Extension implements
	 ...
	 * policy and inhibit policy mapping. The extension is marked non-critical.
	 * 
	 * @param require
	 *            require explicit policy (-1 for optional).
	 * @param inhibit
	...
	/**
	 * Create a PolicyConstraintsExtension object with specified criticality and
