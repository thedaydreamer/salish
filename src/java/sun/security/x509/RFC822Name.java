...
public class RFC822Name implements GeneralNameInterface {
	...
	/**
	 * Parse an RFC822Name string to see if it is a valid addr-spec according to
	 * IETF RFC822 and RFC2459: [local-part@]domain
	 * <p>
	 * local-part@ could be empty for an RFC822Name NameConstraint, but the
	 * domain at least must be non-empty. Case is not significant.
	 * 
	 * @param name
	 *            the RFC822Name string
	 * @throws IOException
	 ...
	 * 
	 * @param out
	 *            the DER stream to encode the RFC822Name to.
	 * @exception IOException
	 *                on encoding errors.
	 */
	 ...
	 * path verification.
	 * <p>
	 * [RFC2459] When the subjectAltName extension contains an Internet mail
	 * address, the address MUST be included as an rfc822Name. The format of an
	 * rfc822Name is an "addr-spec" as defined in RFC 822 [RFC 822]. An
	 * addr-spec has the form "local-part@domain". Note that an addr-spec has no
	 * phrase (such as a common name) before it, has no comment (text surrounded
	 * in parentheses) after it, and is not surrounded by "&lt;" and "&gt;".
	 * Note that while upper and lower case letters are allowed in an RFC 822
