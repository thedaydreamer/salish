 ...
 * policies under which the certificate has been issued and the purposes for
 * which the certificate may be used.
 * <p>
 * Applications with specific policy requirements are expected to have a list of
 * those policies which they will accept and to compare the policy OIDs in the
 * certificate to that list. If this extension is critical, the path validation
 * software MUST be able to interpret this extension (including the optional
 * qualifier), or MUST reject the certificate.
 * <p>
 * Optional qualifiers are not supported in this implementation, as they are not
...
public class CertificatePoliciesExtension extends Extension implements
	...
	/**
	 * Create a CertificatePoliciesExtension object from a List of
	 * PolicyInformation; the criticality is set to false.
	 * 
	 * @param certPolicies
	...
	/**
	 * Create a CertificatePoliciesExtension object from a List of
	 * PolicyInformation with specified criticality.
	 * 
	 * @param critical
