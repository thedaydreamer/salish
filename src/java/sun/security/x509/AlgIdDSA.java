 ...
 * 
 * <P>
 * <em><b>NOTE:</b>  DSS/DSA Algorithm IDs may be created without these
...
public final class AlgIdDSA extends AlgorithmId implements DSAParams {
	 ...
	 * 
	 * @param p
	 *            the DSS/DSA paramter "P"
	 * @param q
	 *            the DSS/DSA paramter "Q"
	 * @param g
	...
	/**
	 * Constructs a DSS/DSA Algorithm ID from numeric parameters. If all three
	 * are null, then the parameters portion of the algorithm id is set to null.
	 * See note in header regarding use.
	 * 
	 * @param p
	 *            the DSS/DSA paramter "P"
	 * @param q
