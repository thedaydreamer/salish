...
public class OIDMap {
	...
	private static final int NetscapeCertType_data[] = { 2, 16, 840, 1, 113730,
			1, 1 };
	...
	static {
		...
		addInternal(
				NETSCAPE_CERT,
				ObjectIdentifier.newInternal(new int[] { 2, 16, 840, 1, 113730,
						1, 1 }), "sun.security.x509.NetscapeCertTypeExtension");
	 ...
	 * @param oid
	 *            the string representation of the object identifier for the
	 *            class.
	 * @param clazz
	 *            the Class object associated with this attribute
	 ...
	 * 
	 * @param oid
	 *            the name of the object identifier to be returned.
