 ...
 * @see Extension
 */
public class BasicConstraintsExtension extends Extension implements
		CertAttrSet<String> {
	/**
	...
	/**
	 * Default constructor for this object. The extension is marked critical if
	 * the ca flag is true, false otherwise.
	 * 
	 * @param ca
	 *            true, if the subject of the Certificate is a CA.
	 * @param len
	 ...
	 * 
	 * @param critical
	 *            true, if the extension should be marked critical
	 * @param ca
	 *            true, if the subject of the Certificate is a CA.
	 * @param len
	 *            specifies the depth of the certification path.
	 ...
	 * 
	 * @param critical
	 *            flag indicating if extension is critical or not
	 * @param value
	 *            an array containing the DER encoded bytes of the extension.
	...
	public BasicConstraintsExtension(Boolean critical, Object value)
		...
		/*
		 * Activate this check once again after PKIX profiling is a standard and
		 * this check no longer imposes an interoperability barrier. if (ca) {
		 * if (!this.critical) { throw new
