 ...
 * @see CertAttrSet
 */
public class PrivateKeyUsageExtension extends Extension implements
		CertAttrSet<String> {
	/**
	 ...
	 * 
	 * @param notBefore
	 *            the date/time before which the private key should not be used.
	 * @param notAfter
	 *            the date/time after which the private key should not be used.
	 */
