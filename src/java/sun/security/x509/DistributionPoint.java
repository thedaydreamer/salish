...
/**
 * Represent the DistributionPoint sequence used in the CRL Distribution Points
 ...
 * </pre>
 * <p>
 * Instances of this class are designed to be immutable. However, since this is
 * an internal API we do not use defensive cloning for values for performance
 * reasons. It is the responsibility of the consumer to ensure that no mutable
...
public class DistributionPoint {
	...
	private static final String[] REASON_STRINGS = { null, "key compromise",
	 ...
	 * 
	 * @param fullName
	 *            the GeneralNames of the distribution point; may be null
	 * @param reasons
	 *            the CRL reasons included in the CRL at this distribution
	 *            point; may be null
	 * @param issuer
	 *            the name(s) of the CRL issuer for the CRL at this distribution
	 *            point; may be null
	 */
	 ...
	 * 
	 * @param relativeName
	 *            the RelativeDistinguishedName of the distribution point; may
	 *            not be null
	 * @param reasons
	 *            the CRL reasons included in the CRL at this distribution
	 *            point; may be null
	 ...
	 * 
	 * @param val
	 *            the DER encoded form of the DistributionPoint
	 * @throws IOException
	 *             on error
	 */
	...
	public void encode(DerOutputStream out) throws IOException {
		...
		if ((fullName != null) || (relativeName != null)) {
			...
			if (fullName != null) {
				...
				distributionPoint.writeImplicit(DerValue.createTag(
						DerValue.TAG_CONTEXT, true, TAG_FULL_NAME), derOut);
			} else if (relativeName != null) {
				DerOutputStream derOut = new DerOutputStream();
				relativeName.encode(derOut);
				distributionPoint.writeImplicit(DerValue.createTag(
						DerValue.TAG_CONTEXT, true, TAG_REL_NAME), derOut);
			}
			tagged.write(
