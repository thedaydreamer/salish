 ...
 * 
 * It is used in the CRL Distribution Points Extension (OID = 2.5.29.31) and the
 * Issuing Distribution Point Extension (OID = 2.5.29.28).
 * <p>
...
public class DistributionPointName {
	 ...
	 * 
	 * @param fullName
	 *            the name for the distribution point.
	 * @exception IllegalArgumentException
	 *                if <code>fullName</code> is null.
	 */
	 ...
	 * 
	 * @param relativeName
	 *            the name of the distribution point relative to the name of the
	 *            issuer of the CRL.
	 * @exception IllegalArgumentException
	 *                if <code>relativeName</code> is null.
	 */
	...
	public void encode(DerOutputStream out) throws IOException {
		...
		if (fullName != null) {
			...
			out.writeImplicit(DerValue.createTag(DerValue.TAG_CONTEXT, true,
					TAG_FULL_NAME), theChoice);

		} else {
			relativeName.encode(theChoice);
			out.writeImplicit(DerValue.createTag(DerValue.TAG_CONTEXT, true,
					TAG_RELATIVE_NAME), theChoice);
		}
	}
