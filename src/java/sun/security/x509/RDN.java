...
public class RDN {
	 ...
	 * using '+' as a separator. If the '+' should be considered part of an AVA
	 * value, it must be preceded by '\'.
	 * 
	 * @param name
	 *            String form of RDN
	 * @throws IOException
	...
	public RDN(String name, Map<String, String> keywordMap) throws IOException {
		...
		while (nextPlus >= 0) {
			...
			/*
			 * We have encountered an AVA delimiter (plus sign). If the plus
			 * sign in the RDN under consideration is preceded by a backslash
			 * (escape), or by a double quote, it is part of the AVA. Otherwise,
			 * it is used as a separator, to delimit the AVA under consideration
			 * from any subsequent AVAs.
			 */
	...
	/*
	 * Constructs an RDN from an ASN.1 encoded value. The encoding of the name
	...
	/*
	 * Creates an empty RDN with slots for specified number of AVAs.
	 * 
	...
	/*
	 * Returns a printable form of this RDN, using RFC 1779 style catenation of
	 * attribute/value assertions, and emitting attribute type keywords from
	 * RFCs 1779, 2253, and 3280.
	 */
	...
	/*
	 * Returns a printable form of this RDN using the algorithm defined in RFC
	 * 1779. Only RFC 1779 attribute type keywords are emitted.
	 */
	...
	/*
	 * Returns a printable form of this RDN using the algorithm defined in RFC
	 * 1779. RFC 1779 attribute type keywords are emitted, as well as keywords
	 * contained in the OID/keyword map.
	 */
	...
	/*
	 * Returns a printable form of this RDN using the algorithm defined in RFC
	 * 2253. RFC 2253 attribute type keywords are emitted, as well as keywords
	 * contained in the OID/keyword map.
	 */
	...
	/*
	 * Returns a printable form of this RDN using the algorithm defined in RFC
	 * 2253. Only RFC 2253 attribute type keywords are emitted. If canonical is
	 * true, then additional canonicalizations documented in
	 * X500Principal.getName are performed.
	 */
...
class AVAComparator implements Comparator<AVA> {
	...
	/**
	 * AVA's containing a standard keyword are ordered alphabetically, followed
	 * by AVA's containing an OID keyword, ordered numerically
	 */
