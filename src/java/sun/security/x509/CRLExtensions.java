...
/**
 * This class defines the CRL Extensions. It is used for both CRL Extensions and
 * CRL Entry Extensions, which are defined are follows:
 * 
 * <pre>
...
public class CRLExtensions {
	 ...
	 * @param isExplicit
	 *            the tag indicating whether this is an entry extension (false)
	 *            or a CRL extension (true).
	 * @exception CRLException
	 *                on encoding errors.
	 */
	 ...
	 * 
	 * @param alias
	 *            the identifier string for the extension to retrieve.
	 */
	 ...
	 * 
	 * @param alias
	 *            the identifier string for the extension to set.
	 * @param obj
	 *            the Object to set the extension identified by the alias.
	 */
	 ...
	 * 
	 * @param alias
	 *            the identifier string for the extension to delete.
	 */
	...
	/**
	 * Compares this CRLExtensions for equality with the specified object. If
	 * the <code>other</code> object is an <code>instanceof</code>
	 * <code>CRLExtensions</code>, then all the entries are compared with the
	 * entries from this.
	 * 
	 * @param other
	 *            the object to test for equality with this CRLExtensions.
	 * @return true iff all the entries match that of the Other, false
	 *         otherwise.
	 */
	public boolean equals(Object other) {
		...
		if (!(other instanceof CRLExtensions))
			return false;
		Collection<Extension> otherC = ((CRLExtensions) other)
				.getAllExtensions();
	...
	/**
	 * Returns a string representation of this <tt>CRLExtensions</tt> object in
