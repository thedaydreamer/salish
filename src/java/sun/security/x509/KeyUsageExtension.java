...
public class KeyUsageExtension extends Extension implements CertAttrSet<String> {
	...
	/**
	 * Create the extension from the passed DER encoded value of the same. The
	 * DER encoded value may be wrapped in an OCTET STRING.
	 * 
	 * @param critical
	 *            true if the extension is to be treated as critical.
	 * @param value
	 *            an array of DER encoded bytes of the actual value (possibly
