...
public class X509CRLEntryImpl extends X509CRLEntry {
	...
	/**
	 * Constructs a revoked certificate entry using the given serial number and
	 * revocation date.
	 * 
	 * @param num
	...
	/**
	 * Constructs a revoked certificate entry using the given serial number,
	...
	/**
	 * Returns the ASN.1 DER-encoded form of this CRL Entry, which corresponds
	...
	/**
	 * Gets the serial number from this X509CRLEntry, i.e. the
	...
	/**
	 * Gets a Set of the extension(s) marked CRITICAL in this X509CRLEntry. In
	 ...
	 * In the returned set, each extension is represented by its OID string.
	 * 
	 * @return a set of the extension oid strings in the Object that are marked
	 *         critical.
	 */
	...
	/**
	 * Utility method to convert an arbitrary instance of X509CRLEntry to a
	 * X509CRLEntryImpl. Does a cast if possible, otherwise reparses the
	 * encoding.
	 */
