 ...
 * <p>
 * The AIA extension identifies how to access CA information and services for
 * the certificate in which it appears. It enables CAs to issue their
 * certificates pre-configured with the URLs appropriate for contacting services
 * relevant to those certificates. For example, a CA may issue a certificate
 * that identifies the specific OCSP Responder to use when performing on-line
 * validation of that certificate.
 * <p>
 * This extension is defined in <a
 * href="http://www.ietf.org/rfc/rfc3280.txt">Internet X.509 PKI Certificate and
 * Certificate Revocation List (CRL) Profile</a>. The profile permits the
 * extension to be included in end-entity or CA certificates, and it must be
 * marked as non-critical. Its ASN.1 definition is as follows:
 * 
 * <pre>
...
public class AuthorityInfoAccessExtension extends Extension implements
		CertAttrSet<String> {
	...
	/**
	 * Create an AuthorityInfoAccessExtension from a List of AccessDescription;
