...
public class Extension {
	 ...
	 * octet string which is in the certificate. This method does not return a
	 * clone; it is the responsibility of the caller to clone the array if
	 * necessary.
	 */
	 ...
	 * <code>other</code> object is an <code>instanceof</code>
	 * <code>Extension</code>, then its encoded form is retrieved and compared
	 * with the encoded form of this Extension.
	 * 
	 * @param other
