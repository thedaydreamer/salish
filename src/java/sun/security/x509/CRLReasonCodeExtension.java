 ...
 * reason for the certificate revocation. CAs are strongly encouraged to include
 * reason codes in CRL entries; however, the reason code CRL entry extension
 ...
 * @see CertAttrSet
 */
public class CRLReasonCodeExtension extends Extension implements
		CertAttrSet<String> {
	...
	/**
	 * Create a CRLReasonCodeExtension with the passed in reason. Criticality
	 * automatically set to false.
	 * 
	 * @param reason
	 *            the enumerated value for the reason code.
	 */
	...
	public String toString() {
		...
		case AA_COMPROMISE:
			...
			break;
		default:
			s += "Unrecognized reason code (" + reasonCode + ")";
		}
		return (s);
	}
