 ...
 * 
 * <p>
 * The inhibit any-policy extension can be used in certificates issued to CAs.
 * The inhibit any-policy indicates that the special any-policy OID, with the
 * value {2 5 29 32 0}, is not considered an explicit match for other
 * certificate policies. The value indicates the number of additional
 * certificates that may appear in the path before any- policy is no longer
 * permitted. For example, a value of one indicates that any-policy may be
 * processed in certificates issued by the sub- ject of this certificate, but
 * not in additional certificates in the path.
 * <p>
 * This extension MUST be critical.
 * <p>
 * The ASN.1 syntax for this extension is: <code><pre>
 ...
 * @see Extension
 */
public class InhibitAnyPolicyExtension extends Extension implements
		CertAttrSet<String> {
	 ...
	 * 
	 * @param skipCerts
	 *            specifies the depth of the certification path. Use value of -1
	 *            to request unlimited depth.
	 */
	 ...
	 * 
	 * @param critical
	 *            criticality flag to use. Must be true for this extension.
	 * @param value
	 *            a byte array holding the DER-encoded extension value.
	 ...
	 * 
	 * @param out
	 *            the DerOutputStream to encode the extension to.
	 */
	 ...
	 * 
	 * @param name
	 *            name of attribute to set. Must be SKIP_CERTS.
	 * @param obj
	 *            value to which attribute is to be set. Must be Integer type.
	 * @throws IOException
	 *             on error
	 */
	 ...
	 * 
	 * @param name
	 *            name of attribute to get. Must be SKIP_CERTS.
	 * @returns value of the attribute. In this case it will be of type Integer.
	 * @throws IOException
	 *             on error
	 */
	 ...
	 * 
	 * @param name
	 *            name of attribute to delete. Must be SKIP_CERTS.
	 * @throws IOException
	 *             on error. In this case, IOException will always be thrown,
	 *             because the only attribute, SKIP_CERTS, is required.
	 */
