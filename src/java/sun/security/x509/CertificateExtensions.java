...
public class CertificateExtensions implements CertAttrSet<Extension> {
	 ...
	 * 
	 * @param in
	 *            the DerInputStream to read the Extension from.
	...
	/**
	 * Encode the extensions in DER form to the stream, setting the context
	 * specific tag as needed in the X.509 v3 certificate.
	 * 
	 * @param out
	 ...
	 *            the DerOutputStream to marshal the contents to.
	 * @param isCertReq
	 *            if true then no context specific tag is added.
	 * @exception CertificateException
	 *                on encoding errors.
	 * @exception IOException
	 *                on errors.
	 ...
	 * 
	 * @param name
	 *            the extension name used in the cache.
	 * @param obj
	 *            the object to set.
	 * @exception IOException
	 ...
	 * 
	 * @param name
	 *            the extension name used in the lookup.
	 * @exception IOException
	 ...
	 * object. If the <code>other</code> object is an <code>instanceof</code>
	 * <code>CertificateExtensions</code>, then all the entries are compared
	 * with the entries from this.
	 * 
	 * @param other
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CertificateExtensions))
			return false;
		Collection<Extension> otherC = ((CertificateExtensions) other)
				.getAllExtensions();
	...
	public String toString() {
		return super.toString()
				...
				+ new sun.misc.HexDumpEncoder()
						.encodeBuffer(getExtensionValue());
	}
}
