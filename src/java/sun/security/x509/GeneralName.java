...
public class GeneralName {
	 ...
	 *            true if general name is a name constraint
	 */
	 ...
	 * 
	 * @param other
	 *            GeneralName to compare to this
	 ...
	 * 
	 * @param out
	 *            the DerOutputStream to encode the the GeneralName to.
	...
	public void encode(DerOutputStream out) throws IOException {
		...
		if (nameType == GeneralNameInterface.NAME_ANY
			...
			out.write(DerValue.createTag(DerValue.TAG_CONTEXT, true,
					(byte) nameType), tmp);
		} else {
			// implicit, primitive form
			out.writeImplicit(DerValue.createTag(DerValue.TAG_CONTEXT, false,
					(byte) nameType), tmp);
		}
	}
}
