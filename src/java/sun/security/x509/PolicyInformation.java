...
public class PolicyInformation {
	 ...
	 *            the policyIdentifier as a CertificatePolicyId
	 * @param policyQualifiers
	 *            a Set of PolicyQualifierInfo objects. Must not be NULL.
	 *            Specify an empty Set for no qualifiers.
	...
	/**
	 * Create an instance of PolicyInformation, decoding from the passed
	 * DerValue.
	 * 
	 * @param val
	 *            the DerValue to construct the PolicyInformation from.
	 * @exception IOException
	 *                on decoding errors.
	 */
	public PolicyInformation(DerValue val) throws IOException {
		...
		if (val.data.available() != 0) {
			...
			while (opt.data.available() != 0)
				policyQualifiers.add(new PolicyQualifierInfo(opt.data
						.getDerValue().toByteArray()));
		} else {
	 ...
	 * 
	 * @return The CertificatePolicyId object containing the policyIdentifier
	 *         (not a copy).
	 */
	 ...
	 * 
	 * @return a Set of PolicyQualifierInfo objects associated with this
	 *         certificate policy (not a copy). Returns an empty Set if there
	 *         are no qualifiers. Never returns null.
	 */
