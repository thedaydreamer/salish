...
public class X400Address implements GeneralNameInterface {
	 ...
	 * 
	 * @param nameValue
	 *            value of the name as a byte array
	 */
	 ...
	 * 
	 * @param out
	 *            the DER stream to encode the X400Address to.
	 * @exception IOException
	 *                on encoding errors.
	 */
	...
	public int constrains(GeneralNameInterface inputName)
		...
		if (inputName == null)
			...
			// Narrowing, widening, and match constraints not defined in rfc2459
			// for X400Address
