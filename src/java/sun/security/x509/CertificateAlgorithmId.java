...
public class CertificateAlgorithmId implements CertAttrSet<String> {
	...
	/**
	 * Identifier to be used with get, set, and delete methods. When using this
	 * identifier the associated object being passed in or returned is an
	 * instance of AlgorithmId.
	 * 
