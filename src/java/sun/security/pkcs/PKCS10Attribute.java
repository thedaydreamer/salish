 ...
 * Identifier) and a set of DER encoded attribute values.
 * 
...
public class PKCS10Attribute implements DerEncoder {
	...
	/**
	 * Constructs an attribute from a DER encoding. This constructor expects the
	 * value to be encoded as defined above, i.e. a SEQUENCE of OID and SET OF
	 * value(s), not a literal X.509 v3 extension. Only PKCS9 defined attributes
	 * are supported currently.
	 * 
	 * @param derVal
	 *            the der encoded attribute.
	 ...
	 * and the value (any java object).
	 * 
	 * @param attributeId
	 *            the ObjectIdentifier of the attribute.
	 * @param attributeValue
	 *            an instance of a class that implements the attribute
	 *            identified by the ObjectIdentifier.
	 */
	 ...
	 * 
	 * @param attr
	 *            the PKCS9Attribute to create from.
	 */
