...
/**
 * This class implements the <code>EncryptedPrivateKeyInfo</code> type, which is
 * defined in PKCS #8 as follows:
 * 
 * <pre>
...
public class EncryptedPrivateKeyInfo {
	...
	/**
	 * Constructs an <code>EncryptedPrivateKeyInfo</code> from the encryption
	 * algorithm and the encrypted data.
	 */
	...
	public boolean equals(Object other) {
		...
		try {
			...
			byte[] otherEncrInfo = ((EncryptedPrivateKeyInfo) other)
					.getEncoded();
