...
public class PKCS7 {
	 ...
	 * 
	 * @param in
	 *            an input stream holding at least one PKCS7 block.
	 ...
	 * 
	 * @param derin
	 *            a DerInputStream holding at least one PKCS7 block.
	 * @exception ParsingException
	 *                on parsing errors.
	 */
	 ...
	 * 
	 * @param derin
	 *            the ASN.1 encoding of the PKCS#7 block.
	 * @param oldStyle
	 *            flag indicating whether or not the given PKCS#7 block is
	 *            encoded according to JDK1.1.x.
	 */
	...
	private void parseNetscapeCertChain(DerValue val) throws ParsingException,
			IOException {
		...
		for (int i = 0; i < contents.length; i++) {
			...
			try {
				if (certfac == null)
					...
					certificates[i] = (X509Certificate) certfac
	...
	/*
	 * Parses an old-style SignedData encoding (for backwards compatibility with
	 * JDK1.1.x).
	 */
	private void parseOldSignedData(DerValue val) throws ParsingException,
			IOException {
		DerInputStream dis = val.toDerInputStream();
	 ...
	 * 
	 * @param out
	 *            the DerOutputStream to write the encoded data to.
	 * @exception IOException
	 *                on encoding errors.
	 */
	 ...
	 * @param bytes
	 *            the DER encoded content information.
	 * 
	 ...
	 * 
	 * @return the version or null if version is not specified for the content
	 *         type.
	 */
	 ...
	 * 
	 * @return the array of Digest Algorithms or null if none are specified for
	 *         the content type.
	 */
	 ...
	 * 
	 * @return a clone of the array of X.509 certificates or null if none are
	 *         specified for the content type.
	 */
	 ...
	 * 
	 * @return a clone of the array of X.509 crls or null if none are specified
	 ...
	 * 
	 * @return the array of Signer Infos or null if none are specified for the
	 *         content type.
	 */
	...
	/**
	 * Populate array of Issuer DNs from certificates and convert each Principal
