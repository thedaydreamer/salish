 ...
 * Authority, which then creates an X.509 certificate and returns it to the
 * entity that requested it. A certificate request basically consists of the
 * subject's X.500 name, public key, and optionally some attributes, signed
...
public class PKCS10 {
	 ...
	 * 
	 * @param publicKey
	 *            the public key that should be placed into the certificate
	 *            generated by the CA.
	 */
	 ...
	 *            generated by the CA.
	 * @param attributes
	 *            additonal set of PKCS10 attributes requested for in the
	 *            certificate.
	 */
	 ...
	 * 
	 * @param data
	 *            the DER-encoded PKCS #10 request.
	 * @exception IOException
	 *                for low level errors reading the data
	 * @exception SignatureException
	 *                when the signature is invalid
	 * @exception NoSuchAlgorithmException
	 *                when the signature algorithm is not supported in this
	 *                environment
	 */
	 ...
	 * 
	 * @param requester
	 *            identifies the signer (by X.500 name) and provides the private
	 *            key used to sign.
	 * @exception IOException
	 *                on errors.
	 ...
	 * 
	 * @param out
	 *            the print stream where the certificate request will be
	 *            printed.
	 * @exception IOException
	 *                when an output operation failed
	 * @exception SignatureException
	 ...
	 * <code>PKCS10</code>, then its encoded form is retrieved and compared with
	 * the encoded form of this certificate request.
	 * 
	 * @param other
	 *            the object to test for equality with this object.
	 * @return true iff the encoded forms of the two certificate requests match,
	 *         false otherwise.
	 */
	...
	/**
	 * Returns a hashcode value for this certificate request from its encoded
	 * form.
	 * 
