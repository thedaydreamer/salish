...
public class PKCS9Attributes {
	...
	public PKCS9Attributes(ObjectIdentifier[] permittedAttributes,
		...
		if (permittedAttributes != null) {
			this.permittedAttributes = new Hashtable<ObjectIdentifier, ObjectIdentifier>(
	...
	/**
	 * Construct a set of PKCS9 Attributes from the contents of its DER encoding
	 * on a DerInputStream. Accept all attributes supported by class
	 * PKCS9Attribute and reject any unsupported attributes.
	 * 
	 * @param in
	 *            the contents of the DER encoding of the attribute set.
	 * @exception IOException
	 ...
	 * Construct a set of PKCS9 Attributes from the contents of its DER encoding
	 * on a DerInputStream. Accept all attributes supported by class
	 * PKCS9Attribute and ignore any unsupported attributes, if directed.
	 * 
	 * @param in
	 *            the contents of the DER encoding of the attribute set.
	 * @param ignoreUnsupportedAttributes
	 *            If true then any attributes not supported by the
	 *            PKCS9Attribute class are ignored. Otherwise unsupported
	...
	/**
	 * Construct a set of PKCS9 Attributes from the given array of PKCS9
	...
	/**
	 * Decode this set of PKCS9 attributes from the contents of its DER
	 * encoding. Ignores unsupported attributes when directed.
	 * 
	 * @param in
	 *            the contents of the DER encoding of the attribute set.
	 * 
	 ...
	 * 
	 * @param tag
	 *            the implicit tag to use in the DER encoding.
	 * @param out
	 *            the output stream on which to put the DER encoding.
	 * 
	 * @exception IOException
	 *                on output error.
	 */
