...
public class SignerInfo implements DerEncoder {
	...
	public SignerInfo(X500Name issuerName, BigInteger serial,
			AlgorithmId digestAlgorithmId,
	 ...
	 * 
	 * <p>
	 * This constructor is used only for backwards compatibility with PKCS#7
	 * blocks that were generated using JDK1.1.x.
	 * 
	 * @param derin
	 *            the ASN.1 encoding of the signer info.
	 * @param oldStyle
	 *            flag indicating whether or not the given signer info is
	...
	public SignerInfo(DerInputStream derin, boolean oldStyle)
		...
		if (oldStyle) {
			...
			if (derin.available() != 0
				...
				unauthenticatedAttributes = new PKCS9Attributes(derin, true);// ignore
																				// unsupported
																				// attrs
			}
		}
	...
	SignerInfo verify(PKCS7 block, byte[] data)
		...
		try {
			...
			if (keyUsageBits != null) {
				...
				boolean nonRepuAllowed = ((Boolean) keyUsage
						.get(KeyUsageExtension.NON_REPUDIATION)).booleanValue();
