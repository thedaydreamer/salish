...
public class ContentInfo {
	...
	static {
		 ...
		 * defined <a
		 * href=http://wp.netscape.com/eng/security/comm4-cert-download.html>
		 * here.</a>
		 */
	 ...
	 * 
	 * @param derin
	 *            the ASN.1 encoding of the content info.
	 * @param oldStyle
	 *            flag indicating whether or not the given content info is
	...
	public ContentInfo(DerInputStream derin, boolean oldStyle)
		...
		if (oldStyle) {
			...
			if (typeAndContent.length > 1) { // content is OPTIONAL
				...
				disTaggedContent = new DerInputStream(
						taggedContent.toByteArray());
