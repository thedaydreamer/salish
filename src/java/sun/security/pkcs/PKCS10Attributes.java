...
/**
 * This class defines the PKCS10 attributes for the request. The ASN.1 syntax
 * for this is:
 * 
 * <pre>
...
public class PKCS10Attributes implements DerEncoder {
	...
	private Hashtable<String, PKCS10Attribute> map = new Hashtable<String, PKCS10Attribute>(
			3);
	 ...
	 * 
	 * @param attrs
	 *            the array of PKCS10Attribute objects.
	 */
	...
	/**
	 * Create the object, decoding the values from the passed DER stream. The
	 * DER stream contains the SET OF Attribute.
	 * 
	 * @param in
	 *            the DerInputStream to read the attributes from.
	 ...
	 * 
	 * @param out
	 *            the OutputStream to marshal the contents to.
	 * @exception IOException
	 *                on encoding errors.
	 */
	...
	public void derEncode(OutputStream out) throws IOException {
		...
		PKCS10Attribute[] attribs = allAttrs.toArray(new PKCS10Attribute[map
				.size()]);
	...
	/**
	 * Return a Collection of attributes existing within this PKCS10Attributes
	 * object.
	 */
	...
	/**
	 * Compares this PKCS10Attributes for equality with the specified object. If
	 * the <code>other</code> object is an <code>instanceof</code>
	 * <code>PKCS10Attributes</code>, then all the entries are compared with the
	 * entries from this.
	 * 
	 * @param other
	 *            the object to test for equality with this PKCS10Attributes.
	 * @return true if all the entries match that of the Other, false otherwise.
	 */
	public boolean equals(Object other) {
		...
		Collection<PKCS10Attribute> othersAttribs = ((PKCS10Attributes) other)
				.getAttributes();
		PKCS10Attribute[] attrs = othersAttribs
				.toArray(new PKCS10Attribute[othersAttribs.size()]);
	 ...
	 * ASCII characters "<tt>,&nbsp;</tt>" (comma and space).
	 * <p>
	 * Overrides the <tt>toString</tt> method of <tt>Object</tt>.
	 * 
