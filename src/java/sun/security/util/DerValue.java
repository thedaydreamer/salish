 ...
 * RFC 3280, section 4.1.2.4., we assume that this kind of string will contain
...
public class DerValue {
	...
	public DerValue(String value) throws IOException {
		...
		data = init(isPrintableString ? tag_PrintableString : tag_UTF8String,
				value);
	}
	...
	/**
	 * Returns an ASN.1 INTEGER value as a positive BigInteger. This is just to
	 * deal with implementations that incorrectly encode some values as
	 * negative.
	 * 
	 * @return the integer held in this DER value as a BigInteger.
	 */
	 ...
	 * 
	 * @return a string corresponding to the encoded BMPString held in this
	 *         value
	 */
	 ...
	 * 
	 * @return a string corresponding to the encoded UTF8String held in this
	 *         value
	 */
	 ...
	 * 
	 * @return a string corresponding to the encoded GeneralString held in this
	 *         value
	 */
	...
	public Date getGeneralizedTime() throws IOException {
		if (tag != tag_GeneralizedTime) {
			throw new IOException(
					"DerValue.getGeneralizedTime, not a GeneralizedTime: "
							+ tag);
		}
	...
	public boolean equals(DerValue other) {
		...
		return (System.identityHashCode(this.data) > System
				.identityHashCode(other.data)) ? doEquals(this, other)
				: doEquals(other, this);
	}
	 ...
	 * 
	 * @params class the tag class type, one of UNIVERSAL, CONTEXT, APPLICATION
	 *         or PRIVATE
