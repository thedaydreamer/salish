...
public class SignatureFileVerifier {
	...
	/**
	 * Utility method used by JarVerifier and JarSigner to determine the
	 * signature file names and PKCS7 block files names that are supported
	 * 
	 * @param s
	 *            file name
	 * @return true if the input file name is a supported Signature File or
	 *         PKCS7 block file name
	 */
	...
	// * verifying the PKCS7 object.
	// * @throws CertificateException if an error is encountered while
	// generating
	// * the TSA's certpath.
	// */
