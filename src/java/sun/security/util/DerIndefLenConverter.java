...
/**
 * A package private utility class to convert indefinite length DER encoded byte
 * arrays to definite length DER encoded byte arrays.
 * 
 * This assumes that the basic data structure is "tag, length, value" triplet.
 * In the case where the length is "indefinite", terminating end-of-contents
 * bytes are expected.
 * 
...
class DerIndefLenConverter {
	 ...
	 * 
	 * @param lengthByte
	 *            the length byte from a DER encoded object.
	...
	/**
	 * Parse the tag and if it is an end-of-contents tag then add the current
	 * position to the <code>eocList</code> vector.
	 */
	...
	/**
	 * Write the tag and if it is an end-of-contents tag then skip the tag and
	 * its 1 byte length of zero.
	 */
	...
	/**
	 * Parse the length and if it is an indefinite length then add the current
	 * position to the <code>ndefsList</code> vector.
	 */
	...
	/**
	 * Write the length and if it is an indefinite length then calculate the
	 * definite length from the positions of the indefinite length and its
	 * matching EOC terminator. Then, write the value.
	 */
	...
	/**
	 * Converts a indefinite length DER encoded byte array to a definte length
	 * DER encoding.
	 * 
	 * @param indefData
	 ...
	 *                on parsing or re-writing errors.
	 */
