...
/**
 * <p>
 * This class represents the <code>ResourceBundle</code> for the following
 * packages:
 * 
 * <ol>
...
public class AuthResources_de extends java.util.ListResourceBundle {
	...
	private static final Object[][] contents = {
			...
			{ "UnixNumericUserPrincipal: name",
					"Unix numerischer Benutzer-Principal: {0}" },
			{ "UnixPrincipal: name", "Unix-Principal: {0}" },

			// com.sun.security.auth.login.ConfigFile
			{ "Unable to properly expand config",
					"{0} kann nicht ordnungsgem\u00e4\u00df erweitert werden." },
			...
			{ ": error adding Permission ",
					": Fehler beim Hinzuf\u00fcgen der Berechtigung " },
			{ " ", " " },
			{ ": error adding Entry ",
			...
			{ "expected codeBase or SignedBy",
					"codeBase oder SignedBy erwartet" },
