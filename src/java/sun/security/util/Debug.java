...
public class Debug {
	...
	public static void Help() {
		...
		System.err
				.println("scl           permissions SecureClassLoader assigns");
		System.err.println();
		...
		System.err
				.println("failure       before throwing exception, dump stack");
		System.err
				.println("              and domain that didn't have permission");
		System.err.println();
		...
		System.err
				.println("              only dump output if specified codebase");
		System.err.println("              is being checked");
	...
	/**
	 * Get a Debug object corresponding to whether or not the given option is
	 * set. Set the prefix to be the same as option.
	 */
	...
	/**
	 * Get a Debug object corresponding to whether or not the given option is
	 * set. Set the prefix to be prefix.
	 */
	...
	/**
	 * True if the system property "security.debug" contains the string
	 * "option".
	 */
	...
	/**
	 * print a message to stderr that is prefixed with the prefix created from
