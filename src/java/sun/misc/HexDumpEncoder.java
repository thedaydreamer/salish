 ...
 * the past. It is useful for analyzing the contents of binary buffers. The
 * format produced is as follows:
 * 
 * <pre>
 * xxxx: 00 11 22 33 44 55 66 77   88 99 aa bb cc dd ee ff ................
 * </pre>
 * 
 * Where xxxx is the offset into the buffer in 16 byte chunks, followed by ascii
 * coded hexadecimal bytes followed by the ASCII representation of the bytes or
 * '.' if they are not valid bytes.
 * 
