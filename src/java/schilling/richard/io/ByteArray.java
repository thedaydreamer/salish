...
/**
 * Wrapper for a <code>byte[]</code>, which provides read-only access and can
...
public final class ByteArray {
	 ...
	 * 
	 * @param bytes
	 *            non-null; the underlying array
	 * @param start
	 *            <code>&gt;= 0</code>; start index of the slice (inclusive)
	 * @param end
	 *            <code>&gt;= start, &lt;= bytes.length</code>; end index of the
	 *            slice (exclusive)
	 */
	 ...
	 *            <code>&gt;= 0</code>; start index of the slice (inclusive)
	 * @param end
	 *            <code>&gt;= start, &lt;= size()</code>; end index of the slice
	 *            (exclusive)
	 ...
	 * @param bytes
	 *            non-null; (alleged) underlying array
	 * @return corresponding offset into <code>bytes</code>
	 * @throws IllegalArgumentException
	 *             thrown if <code>bytes</code> is not the underlying array of
	 *             this instance
	 */
	 ...
	 * <code>byte[]</code> at the given offset. The given array must be large
	 * enough.
	 * 
	 * @param out
	 *            non-null; array to hold the output
	 * @param offset
	 *            non-null; index into <code>out</code> for the first byte of
	 *            output
	 */
	...
	/**
	 * Gets the <code>signed byte</code> value at the given offset, without
	 * doing any argument checking.
	 * 
	 * @param off
	 *            offset to fetch
	...
	/**
	 * Gets the <code>unsigned byte</code> value at the given offset, without
	 * doing any argument checking.
	 * 
	 * @param off
	 *            offset to fetch
