...
public final class TwoColumnOutput {
	 ...
	 * 
	 * @param s1
	 *            non-null; first string
	 * @param width1
	 *            &gt; 0; width of the first column
	 * @param spacer
	 *            non-null; spacer string
	 * @param s2
	 *            non-null; second string
	 * @param width2
	 *            &gt; 0; width of the second column
	 ...
	 * @param leftWidth
	 *            &gt; 0; width of the left column, in characters
	 * @param rightWidth
	 ...
	 * 
	 * @param out
	 *            non-null; stream to send final output to
	 * @param leftWidth
	 *            &gt;= 1; width of the left column, in characters
	 * @param rightWidth
