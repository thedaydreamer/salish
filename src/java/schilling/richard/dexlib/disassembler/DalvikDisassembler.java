...
/**
 * Disassemble a DEX file. This is not currently used, but reserved for future
 * use.
 * 
 * @author rschilling
 */
public class DalvikDisassembler {
    ...
    public ProgressTracker FinnrApp;
    ...
    private void disassembleDexFile(String inlineTable) throws IOException,
        ...
        // TODO redefine DexLoader when we disassemble (for future use).
        DexLoader loader = new DexLoader(null);
