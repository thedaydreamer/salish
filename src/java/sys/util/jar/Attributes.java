 ...
 * when written to the output stream. See the <a
 * href="../../../../technotes/guides/jar/jar.html">JAR File Specification</a>
...
public class Attributes implements Map<Object, Object>, Cloneable {
		...
		while ((len = is.readLine(lbuf)) != -1) {
			...
			try {
				if ((putValue(name, value) != null) && (!lineContinued)) {
					Logger.getLogger("java.util.jar")
							.warning(
	 ...
	 * will be UTF8-encoded when written to the output stream. See the <a
	 * href="../../../../technotes/guides/jar/jar.html">JAR File
	...
	public static class Name {
		...
		public int hashCode() {
			if (hashCode == -1) {
				hashCode = ASCIICaseInsensitiveComparator
						.lowerCaseHashCode(name);
			}
			return hashCode;
		}
		 ...
		 * 
		 * @see <a
		 *      href="../../../../technotes/guides/jar/jar.html#JAR Manifest">
		 ...
		 * 
		 * @see <a
		 *      href="../../../../technotes/guides/extensions/spec.html#bundled">
		 ...
		 * 
		 * @see <a
		 *      href="../../../../technotes/guides/extensions/spec.html#sealing">
		 *      Extension Sealing</a>
		 */
		 ...
		 * 
		 * @see <a
		 *      href="../../../../technotes/guides/extensions/spec.html#dependency">
