...
public final class MethodId<D, R> {
	...
	MethodId(Type<D> declaringType, Type<R> returnType, String name,
			TypeList parameters) {
		if (declaringType == null || returnType == null || name == null
				|| parameters == null) {
		...
		this.nat = new CstNat(new CstString(name), new CstString(
				descriptor(false)));
