...
public final class PlainCstInsn extends CstInsn {
	...
	public PlainCstInsn(Rop opcode, SourcePosition position,
			RegisterSpec result, RegisterSpecList sources, Constant cst) {
	...
	public Insn withRegisterOffset(int delta) {
		return new PlainCstInsn(getOpcode(), getPosition(), getResult()
	...
	public Insn withNewRegisters(RegisterSpec result, RegisterSpecList sources) {
		...
		return new PlainCstInsn(getOpcode(), getPosition(), result, sources,
				getConstant());
