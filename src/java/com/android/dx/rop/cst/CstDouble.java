...
public final class CstDouble extends CstLiteral64 {
	...
	public static final CstDouble VALUE_0 = new CstDouble(
			Double.doubleToLongBits(0.0));

	/** {@code non-null;} instance representing {@code 1} */
	public static final CstDouble VALUE_1 = new CstDouble(
	 ...
	 * 
	 * @param bits
	 *            the {@code double} value as {@code long} bits
	 */
	public static CstDouble make(long bits) {
		/*
		 * Note: Javadoc notwithstanding, this implementation always allocates.
		 */
