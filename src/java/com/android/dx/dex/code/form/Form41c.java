...
/**
 * Instruction format {@code 41c}. See the instruction format spec for details.
 */
public final class Form41c extends InsnFormat {
	...
	public boolean isCompatible(DalvInsn insn) {
		...
		case 2: {
			/*
			 * This format is allowed for ops that are effectively 2-arg but
			 * where the two args are identical.
			 */
			reg = regs.get(0);
