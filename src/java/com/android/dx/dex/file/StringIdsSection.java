...
public final class StringIdsSection extends UniformItemSection {
	...
	/**
	 * {@code non-null;} map from string constants to {@link StringIdItem}
	 * instances
	 */
	 ...
	 * 
	 * @param string
	 *            {@code non-null;} the string to intern, as a regular Java
	 *            {@code String}
	 ...
	 * 
	 * @param string
	 *            {@code non-null;} the string to intern, as a constant
	 * @return {@code non-null;} the interned string
	 */
	 ...
	 * 
	 * @param string
	 *            {@code non-null;} the string to intern
	 * @return {@code non-null;} the interned string
	 */
	 ...
	 * 
	 * @param string
	 *            {@code non-null;} the string to look up
