...
public abstract class BaseUpdater implements Comparable<BaseUpdater> {
     ...
     * Creates the updater.
     * 
     * @param methodList the method list to add method/class pairs to for later
     *            reporting.
     */
     ...
     * @param injected the method that is updated.
     * @param position the position in the target's decoded instruction array
     ...
     * @param position the position in the decoded's decoded instruction array
     *            that the injection occurred at.
     */
     ...
     * operation.
     * 
     * @param target the target that is to be injected
