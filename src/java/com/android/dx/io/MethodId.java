...
public final class MethodId implements Comparable<MethodId> {
    ...
    /*
     * ClassData.Method methodIndex ProtoId parameters returnType shorty
     * MethodId protoIndex ClassData.Method provides MethodId which provides
     * ProtoId.
     */
     ...
     * @throws IllegalStateException if the DEX file does not contain the
     */
