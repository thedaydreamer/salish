...
public final class ProtoId implements Comparable<ProtoId> {
    ...
    public List<String> getParameters() {
        if (parameters == null) {
            ...
            if (parametersOffset > 0) {
                Section section = buffer.open(parametersOffset);
     ...
     * 
     * @throws VerifyException if a parameter is invalid.
     */
     ...
     * need to do the class lookup. Returned references are assumed to be
     * initialized. Returns kRegTypeUnknown for "void".
     */
    public RegisterType getMethodReturnType() {
        ...
        switch (retType.charAt(0)) {
            ...
            default:
                /*
                 * we verified signature return type earlier, so this is
                 * impossible
                 */
