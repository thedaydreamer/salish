 ...
 * 
 * <pre>
 *      <code> 	public static final Info IGET_BYTE = new Info(Opcodes.IGET_BYTE, "iget-byte", InstructionCodec.FORMAT_22C, IndexType.FIELD_REF); </code>
 * </pre>
 * 
 */
public final class IGET_BYTE extends OpcodeInfo.Info {
	public IGET_BYTE() {
		super(Opcodes.IGET_BYTE, "iget-byte", InstructionCodec.FORMAT_22C,
				IndexType.FIELD_REF);
