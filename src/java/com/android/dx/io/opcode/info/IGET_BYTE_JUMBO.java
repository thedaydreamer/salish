 ...
 * 
 * <pre>
 *      <code> 	public static final Info IGET_BYTE_JUMBO = new Info(Opcodes.IGET_BYTE_JUMBO, "iget-byte/jumbo", InstructionCodec.FORMAT_52C, IndexType.FIELD_REF); </code>
 * </pre>
 * 
 */
public final class IGET_BYTE_JUMBO extends OpcodeInfo.Info {
	public IGET_BYTE_JUMBO() {
		super(Opcodes.IGET_BYTE_JUMBO, "iget-byte/jumbo",
				InstructionCodec.FORMAT_52C, IndexType.FIELD_REF);
		this.verifier = new VerifyIGet1NrCommon() {
			{
				typeToCheck = kRegTypeByte;
			}
