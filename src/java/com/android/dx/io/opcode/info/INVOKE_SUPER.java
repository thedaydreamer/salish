 ...
 * 
 * <pre>
 *      <code> 	public static final Info INVOKE_SUPER = new Info(Opcodes.INVOKE_SUPER, "invoke-super", InstructionCodec.FORMAT_35C, IndexType.METHOD_REF); </code>
 * </pre>
 * 
 */
public final class INVOKE_SUPER extends OpcodeInfo.Info {
	public INVOKE_SUPER() {
		super(Opcodes.INVOKE_SUPER, "invoke-super",
