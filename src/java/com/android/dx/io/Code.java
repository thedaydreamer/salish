...
public class Code implements Cloneable {
    ...
    /**
     * @param registersSize number of registers
     * @param insSize
     * @param outsSize
     ...
     * @param tries
     * @param catchHandlers
     * @param size the number of bytes taken up by the code section.
     */
     ...
     * mDef.
     * 
     * @param mDef MethodDefinition object to get extra data for each
     *            instruction.
     ...
     * 
     * @param mDef the MethodDefinition to retrieve extra information from.
    ...
    public static class CatchHandler implements Cloneable {
        ...
        public CatchHandler(int[] typeIndexes, String[] typeSignatures,
                int[] addresses, int catchAllAddress, int handlerOffset) {
            this(typeIndexes, typeSignatures, addresses, catchAllAddress);
            this.handlerOffset = handlerOffset;
         ...
         * matches oldAddress.
         * 
         * @param oldAddress the address to check for.
         * @param newAddress the address to update to.
         */
     ...
     * 
     * @param outsSize
     * @throws IllegalArgumentException if outsSize is larger than
     *             registersSize.
     */
